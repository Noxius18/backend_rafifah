                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #065f46 0%, #059669 60%, #34d399 100%); padding: 36px 40px 32px 40px; text-align: center;">
                            ...
                            <h1 style="color: #ffffff; font-size: 22px; font-weight: 700; margin: 0 0 6px 0; letter-spacing: -0.3px;">Hasil Ujian</h1>
                    ...
                    <tr>
                        <td style="padding: 36px 40px 28px 40px;">
                            ...
                            <p style="color: #64748b; font-size: 14px; line-height: 1.7; margin: 0 0 28px 0;">
                                Kami ingin memberitahukan bahwa hasil ujian Anda telah tersedia. Berikut ringkasan hasil ujian yang telah Anda ikuti.
                            </p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #f8fafc; border-radius: 10px; border: 1px solid #e2e8f0; margin-bottom: 28px;">
                                <tr>
                                    <td style="padding: 24px 24px 8px 24px;">
                                        <p style="color: #94a3b8; font-size: 11px; font-weight: 700; letter-spacing: 0.8px; text-transform: uppercase; margin: 0 0 16px 0;">Informasi Ujian</p>
                                    </td>
                                </tr>
                                    ...
                                    <td style="padding: 0 24px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                ...
                                                <td style="padding: 12px 0; border-top: 1px solid #e2e8f0; color: #064e3b; font-size: 14px; font-weight: 600; vertical-align: middle;">
                                                    {{ $hasil->jadwalTes ? $hasil->jadwalTes->tanggal : '-' }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td style="padding: 0 24px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                ...
                                                <td style="padding: 12px 0; border-top: 1px solid #e2e8f0; color: #064e3b; font-size: 14px; font-weight: 600; vertical-align: middle;">
                                                    {{ $hasil->jadwalTes ? $hasil->jadwalTes->jam : '-' }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td style="padding: 0 24px 24px 24px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #ecfdf5; border-radius: 8px; margin-top: 12px;">
                                            <tr>
                                                ...
                                                <td style="padding: 14px 16px; color: #059669; font-size: 26px; font-weight: 800; vertical-align: middle; text-align: right;">
                                                    {{ $hasil->total_nilai }}
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #fefce8; border-left: 4px solid #eab308; border-radius: 6px; margin-bottom: 8px;">
                                <tr>
                                    <td style="padding: 14px 16px; color: #854d0e; font-size: 13px; line-height: 1.6;">
                                        📎 <strong>Lampiran tersedia</strong> — File terlampir pada email ini berisi detail lengkap hasil ujian Anda.
                                    </td>
                                </tr>
                            </table>
