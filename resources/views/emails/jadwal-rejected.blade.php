                    ...
                    <tr>
                        <td style="padding: 36px 40px 28px 40px;">
                            ...
                            <p style="color: #64748b; font-size: 14px; line-height: 1.7; margin: 0 0 28px 0;">
                                Jadwal seleksi perlu diperbaiki sesuai catatan dari ketua panitia berikut.
                            </p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #f8fafc; border-radius: 10px; border: 1px solid #e2e8f0; margin-bottom: 28px;">
                                ...
                                <tr>
                                    <td style="padding: 0 24px 24px 24px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #fef3c7; border-left: 4px solid #eab308; border-radius: 6px; margin-top: 12px;">
                                            <tr>
                                                <td style="padding: 14px 16px; color: #92400e; font-size: 13px; line-height: 1.6;">
                                                    <strong style="display: block; margin-bottom: 4px;">📝 Catatan dari Ketua Panitia:</strong>
                                                    <em>{{ $catatan }}</em>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <p style="color: #64748b; font-size: 14px; line-height: 1.7; margin: 0;">
                                Silakan login ke sistem untuk mengedit jadwal tersebut.
                            </p>
