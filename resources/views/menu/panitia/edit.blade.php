        ...
        <div class="rounded-2xl border border-emerald-100 bg-white/90 p-6 shadow-sm">
            <form action="{{ route('panitia.update', $panitia->id_panitia) }}" method="POST" class="space-y-4">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="button" class="btn btn-outline btn-error ml-auto" @click="deleteConfirm()">
...
<script>
    function deleteConfirm() {
        if (confirm('Apakah Anda yakin ingin menghapus panitia ini? Tindakan ini tidak dapat dibatalkan.')) {
