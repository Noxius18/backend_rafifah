        ...
        <section class="space-y-6 px-4 py-4">
            <div class="flex items-center justify-between gap-3">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('panitia.cetak-pdf') }}" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 rounded-lg border border-emerald-200 bg-white px-3.5 py-2 text-sm font-medium text-emerald-700 transition hover:border-emerald-300 hover:bg-emerald-50">
